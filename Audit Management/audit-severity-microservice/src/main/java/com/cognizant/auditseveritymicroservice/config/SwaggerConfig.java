package com.cognizant.auditseveritymicroservice.config;
...
public class SwaggerConfig { 
	...
	public Docket api() { 
		...
		Docket docket= new Docket(DocumentationType.SWAGGER_2)  
				.select()                                  
				.apis(RequestHandlerSelectors.basePackage("com.cognizant.auditseveritymicroservice"))              
	...
	private ApiInfo apiDetails() {
		ApiInfo apiInfo= new ApiInfoBuilder()
				.title("AuditSeverityMicroservice Documentation")
